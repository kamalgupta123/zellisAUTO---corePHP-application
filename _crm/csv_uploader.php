...
if(isset($_POST["Import"])){
	...
	if($_FILES["file"]["size"] > 0)
	{
		...
		$sql2 = "INSERT INTO data (ePID, Make, Model, Year, Submodel, Variant, Plat_Gen, Engine, Body, Type, Ktype, Relationship, RelationshipDetails, version) VALUES ";
		$mfl = 0;
		...
		while (($getData = fgetcsv($file, 10000, ",")) !== FALSE)
		{
			if($flag==0){
			 ...
			 $flag=$flag+1;
				...
				{
					// INSERT Loop
					$mdata = " ('".$getData[0]."','".$getData[1]."','".$getData[2]."','".$getData[3]."','".$getData[4]."','".$getData[5]."','".$getData[6]."','".$getData[7]."','".$getData[8]."', '".$getData[9]."','".$getData[10]."','".$getData[11]."','".$getData[12]."','".$ebay_mvl."'),";
					$sql2 .= $mdata;
					$mfl = 1;
				}
...
?>
						 <div id="wrap">
						     	<p class="uploader_heading">Load eBay Master Vehicle List</p>
								 <div class="container">
										 <div class="row">
